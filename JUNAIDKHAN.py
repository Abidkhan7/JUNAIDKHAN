...
def pkgs():
        ...
        love("\033[1;95mK4KHAN 2nd Tool Start ComingSoon New Update»")
        love("\033[1;96m «-----------------\033[1;92mJUNAID KHAN\033[1;96m--------------»")
        time.sleep(0.3)
...
##### LOGO #####
logo = """
\033[1;96mPAK HACKERS░░░\033[1;92m░░░JUNAIDKHAN╗░░WEBDEVELOPER╗░AND╗░░A\033[1;91mETICALHACKER╗
\033[1;96mYT╔══TERMUX╗MASTER║░\033[1;92m░░░░WEBHACKER╔══PAK╗ANONAYMOUS╔══YOUTUBE╗CHANNEL║\033[1;91m░K4_KHAN_TERMUX_MASTER╔╝
\033[1;96mPAKISTANI╦╝HACKERS\033[1;92m║░░░░░███████║██║░░╚═╝\033[1;91m█████═╝░
\033[1;96mWEBHACKER╔══JUNAIDKHAN╗\033[1;92m██║░░░░░██╔══██║██║░░\033[1;91m██╗██╔═██╗░
...
\033[1;92mVISIT╔█OUR█╔YT║█CHANNEL█\033[1;91mB4║█KHAN█╗░░TERMUX║██MASTER██║
\033[1;92m██║╚██╔╝██║██╔\033[1;91m══██║██╔══╝░░██║██╔══██║
\033[1;92m██║░╚═╝░██║█\033[1;91m█║░░██║██║░░░░░██║██║░░██║
\033[1;92m╚═╝░░░░░╚═\033[1;91m╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝
\033[1;47m\033[1;31m      PAKISTANI HACKER       \033[1;0m
\033[1;96m«-----------------\033[1;91mJUNAID KHAN\033[1;96m-----------------»
...
def menu():
    ...
    os.system('echo  WHATSAPP░░░░░03410003464░░FOR THIS SCRIPT░ | lolcat -a -F 0.1')
    os.system('echo  CONTACT  ░░░░░ME ON WHATSAPP░░JUNAID TERMUX MASTER░ | lolcat -a -F 0.1')
    os.system('echo  WE ARE ░░ANONAYMOUS░WE ARE LEGENDS WE NEVER FORGIVE| lolcat -a -F 0.1')
    os.system('echo  WE NEVER FORGET░ASPECT ░░ US ░KNOWLEDGE░IS░░FREE | lolcat -a -F 0.1')
    os.system('echo  HI, I AM JUNAID KHAN A ETHICAL HACKER | lolcat -a -F 0.1')
    os.system('echo  WE ARE ANONYMOUS WE ARE LEGION WE NEVER FORGIVE WE NEVER FORGET ASPECT US | lolcat -a -F 0.1')
    os.system('echo  JUNAID KHAN WHATSAPP = 03410003464 | lolcat -a -F 0.1')
    os.system('echo  VISIT OUR YOUTUBE CHANNEL JUNAID KHAN TERMUX MASTER | lolcat -a -F 0.1')
    os.system('echo  PAKISTANI ETHICAL HACKER AND A PROGRAMMER | lolcat -a -F 0.1')
    os.system('echo  LETS░░░░░ENJOY░░OUR░░░░░TOOL░░THANKS | lolcat -a -F 0.1')
    os.system('echo  ------ ALWAYS LOVE YOUR MOTHER BECOUSE YOU WILL NEVER GET ANOTHER------&&date  | lolcat -a -F 0.1')
    os.system('echo ----------------JUNAID KHAN----------------| lolcat')
    os.system('echo  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  JUNAID KHAN| lolcat --animate')
    os.system('echo  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  JUNAID KHAN| lolcat --animate')
    os.system('echo  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈| lolcat')
    os.system('echo  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp| lolcat --animate')
    os.system('echo  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈03410003464| lolcat --animate')
    os.system('echo -----------------JUNAID KHAN---------------| lolcat --animate')
    ...
    time.sleep(0.0005)
    os.system('echo         Type python2 JUNAIDKHAN.py| lolcat --animate')
    os.system('echo -----------------JUNAID KHAN----------------| lolcat --animate')
    time.sleep(0.0005)
    ...
    time.sleep(0.0005)
    os.system('echo [L]  Install JUNAIDKHAN Clonnig----------------- Tool ----● | lolcat --animate')
    time.sleep(0.0005)
    ...
    time.sleep(0.0005)
    os.system('echo [W]  JUNAID KHAN TERMUX MASTER WhatsApp Group-------- Tool----● | lolcat --animate')
    time.sleep(0.0005)
...
def mafia():
        ...
        if black =="":
                ...
                love("\033[1;93mTool User Name Junaid Password Khan")
                time.sleep(5)
                ...
                love("Now you can open this tool as usual")
                love("\033[1;93mTool User Name\033[1;92m Junaid\033[1;93m Password \033[1;92mKhan")
                time.sleep(6)
                ...
                print(logo)
                print(logo)
                os.system("rm -rf $HOME/JUNAIDKHAN")
                os.system("cd $HOME && git clone https://github.com/Abidkhan7/JUNAIDKHAN.git")
                print (logo)
                love("\033[1;93mCongratulations JUNAIDKHAN Tool Has Been Installed Successfully")
                love("Now you can open this tool as usual")
                ...
                os.system("cd $HOME && git clone https://github.com/Abidkhan7/JUNAIDKHAN.git")
                print (logo)
                love("\033[1;91mCongratulations JUNAIDKHAN Tool Has Been Installed Successfully")
                love("Now you can open this tool as usual")
                love("\033[1;96mAdmin Panel Finder")
                time.sleep(5)
                os.system("cd $HOME/JUNAIDKHAN && python2 JUNAIDKHAN.py")
                ...
                os.system("cd $HOME && git clone https://github.com/Abidkhan7/JUNAIDKHAN.git")
                print (logo)
                love("\033[1;96mCongratulations JUNAIDKHAN Tool Has Been Installed Successfully")
                love("Now you can open this tool as usual")
                ...
                os.system("cd $HOME && git clone https://github.com/Abidkhan7/JUNAIDKHAN.git")
                print (logo)
                love("\033[1;93mCongratulations JUNAIDKHAN Payload Tool Has Been Installed Successfully")
                love("Now you can open this tool as usual")
                time.sleep(5)
                os.system("cd $HOME/JUNAIDKHAN && python3 JUNAIDKHAN.py")
                ...
                clear()
                print(logo)
                love("Welcome To JUNAID TERMUX MASTER WhatsApp Group")
                time.sleep(5)
                os.system('xdg-open https://chat.whatsapp.com/BcmyQPBz6lz3t6oVN8wLoi')
        elif black =="X" or black =="x":
                clear()
                print(logo)
                love("Welcome To JUNAIDKHAN 2nd Tool")
                love("JUNAIDKHAN 2nd Tool Start")
                ...
                print (logo)
                love("\033[1;96mCongratulations JUNAIDKHAN Tool Has Been Update Successfully")
                time.sleep(5)
